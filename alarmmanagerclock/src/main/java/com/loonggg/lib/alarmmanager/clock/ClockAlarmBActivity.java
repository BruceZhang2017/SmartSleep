...
public class ClockAlarmBActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showDialogInBroadcastReceiver(title, message, flag, index);
    }

    private void showDialogInBroadcastReceiver(String title, String message, final int flag, int index) {
        if (flag == 1 || flag == 2) {
