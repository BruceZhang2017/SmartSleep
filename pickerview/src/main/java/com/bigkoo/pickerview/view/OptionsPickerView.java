...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            LinearLayout ll_picker_view = (LinearLayout)findViewById(R.id.ll_pickerview_options);
            int padding = BottomNavigationHelper.getVirtualBarHeight(mPickerOptions.context);
            System.out.println("padding: " + padding);
            ll_picker_view.setPadding(0,0,0,padding);
            ...
            //rv_top_bar.setBackgroundColor(0xFFF9F9F9);
