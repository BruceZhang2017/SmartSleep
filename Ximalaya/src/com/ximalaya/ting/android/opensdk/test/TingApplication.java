 ...
 */
public class TingApplication implements IComponentApplication {
...
//        XmMediaPlayerFactory.setPlayerMode(true);
        ...
        String mp3 = application.getExternalFilesDir("mp3").getAbsolutePath();
        ...
        if(BaseUtil.isMainProcess(application)) {
            ...
            if(AccessTokenManager.getInstanse().hasLogin()) {
                registerLoginTokenChangeListener(application);
            }
        }

        if(!BaseUtil.isPlayerProcess(application)) {
            XmDownloadManager.Builder(application)
        ...
        if(BaseUtil.isPlayerProcess(application)) {
            ...
            intent1.setClass(application, MyPlayerReceiver.class);
