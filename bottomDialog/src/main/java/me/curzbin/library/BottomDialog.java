...
public class BottomDialog {
    ...
    private final class CustomDialog extends Dialog {
        ...
        private void init() {
            ...
            LinearLayout llBottomDialog = (LinearLayout)findViewById(R.id.ll_bottom_dialog);
            int padding = BottomNavigationHelper.getVirtualBarHeight(context);
            System.out.println("padding: " + padding);
            llBottomDialog.setPadding(0,0,0,padding);
        }
