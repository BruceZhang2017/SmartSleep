...
//    PLAY_MODEL_SINGLE_LOOP
    ...
    private PlayerPresenter() {
        mPlayerManager = XmPlayerManager.getInstance(TingApplication.getAppContext());
        //广告相关的接口
        mPlayerManager.addAdsStatusListener(this);
        //注册播放器状态相关的接口
        mPlayerManager.addPlayerStatusListener(this);
        //需要记录当前的播放模式
        mPlayModSp = TingApplication.getAppContext().getSharedPreferences(PLAY_MODE_SP_NAME,Context.MODE_PRIVATE);
    }
    ...
    public void playByAlbumId(long id) {
        ...
        ximalayApi.getAlbumDetail(new IDataCallBack<TrackList>() {
            ...
            public void onError(int errorCode,String errorMsg) {
                ...
                Toast.makeText(TingApplication.getAppContext(),"请求数据错误...",Toast.LENGTH_SHORT).show();
            }
        },(int) id,1);
        //3、播放了..
    }
