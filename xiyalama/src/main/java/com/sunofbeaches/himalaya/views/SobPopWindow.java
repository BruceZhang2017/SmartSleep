...
import com.sunofbeaches.himalaya.base.TingApplication;
...
public class SobPopWindow extends PopupWindow {
    ...
    public SobPopWindow() {
        ...
        setFocusable(true);
        //载进来View
        mPopView = LayoutInflater.from(TingApplication.getAppContext()).inflate(R.layout.pop_play_list, null);
        //设置内容
    ...
    private void initView() {
        ...
        //设置布局管理器
        LinearLayoutManager layoutManager = new LinearLayoutManager(TingApplication.getAppContext());
    ...
    public void updateOrderIcon(boolean isReverse) {
        ...
        mOrderText.setText(TingApplication.getAppContext().getResources().getString(isReverse ? R.string.order_text : R.string.revers_text));
    }
