...
public class SubscriptionFragment extends BaseFragment implements ISubscriptionCallback, AlbumListAdapter.OnAlbumItemClickListener, AlbumListAdapter.OnAlbumItemLongClickListener, ConfirmDialog.OnDialogActionClickListener {
    ...
    private View createSuccessView() {
        View itemView = LayoutInflater.from(TingApplication.getAppContext()).inflate(R.layout.item_subscription, null);
    ...
    public void onDeleteResult(boolean isSuccess) {
        //给出取消订阅的提示.
        Toast.makeText(TingApplication.getAppContext(), isSuccess ? R.string.cancel_sub_success : R.string.cancel_sub_failed, Toast.LENGTH_SHORT).show();
    }
